...
ground_27 = FootballGround('Elland Road', 'Leeds United F.C.', 'Leeds', 37792, False)
ground_28 = FootballGround('Emirates Stadium', 'Arsenal F.C.', 'London', 60704, False)
ground_29 = FootballGround('Etihad Stadium', 'Manchester City F.C.', 'Manchester', 53400, False)
ground_30 = FootballGround('Falmer Stadium', 'Brighton & Hove Albion F.C.', 'Brighton and Hove', 31800, False)
ground_31 = FootballGround('Goodison Park', "Everton F.C.", 'Liverpool', 39572, False)
ground_32 = FootballGround("King Power Stadium", 'Leicester City F.C.', 'Leicester', 32261, False)
ground_33 = FootballGround('London Stadium', 'West Ham United F.C.', 'London', 62500, False)
ground_34 = FootballGround('Molineux Stadium', 'Wolverhampton Wanderers F.C.', 'Wolverhampton', 32050, False)
ground_35 = FootballGround('Old Trafford', 'Manchester United F.C,', 'Manchester', 74310, False)
ground_36 = FootballGround('Selhurst Park', 'Crystal Palace F.C.', 'London', 25486, False)
ground_37 = FootballGround("St James' Park", 'Newcastle United F.C.', 'Newcastle', 52305, False)
ground_38 = FootballGround("St Mary's Stadium", 'Southampton F.C.', 'Southampton', 32383, False)
ground_39 = FootballGround('Stamford Bridge', 'Chelsea F.C.', 'London', 40341, False)
ground_40 = FootballGround('City Ground', 'Nottingham Forest F.C.', 'Nottingham', 30445, False)
ground_41 = FootballGround('Tottenham Hotspur Stadium', "Tottenham Hotspur F.C.", 'London', 62850, False)
ground_42 = FootballGround("Villa Park", 'Aston Villa F.C.', 'Birmingham', 42749, False)
ground_26 = FootballGround('Vitality Stadium', 'AFC Bournemouth', 'Bournemouth', 11364, False)
